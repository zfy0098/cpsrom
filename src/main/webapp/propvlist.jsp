...
<section class="rt_wrap content mCustomScrollbar">
	<div class="rt_content">
		...
		<table class="table">
	       ...
	       <tr>
	        <td onmouseover="showpic(this)" onmouseout="hidepic();" data-proimg="${list.product.proimg}">
	        	<div class="ellipsis">
	        		<a href="${list.product.prourl}" target="_blank">${list.product.proname}</a>
	        	</div>
	        </td>
	        <td>${list.pvdate}</td>
	        <td>${list.count}</td>
